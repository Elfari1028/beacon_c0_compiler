...
public class Token {
    ...
    public String toString() {
        ...
        builder.append("Line: ").append(this.startPos.row).append(' ');
        builder.append("Column: ").append(this.startPos.col).append(' ');
        builder.append("type: ").append(this.tokenType).append(' ');
